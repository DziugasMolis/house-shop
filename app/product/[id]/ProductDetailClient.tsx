              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <a className="text-gray-600 hover:text-gray-900" href={`tel:${t('contact.phoneText')}`}>
                      {t('contact.phoneText')}
                    </a>
                  </div>
                  <div className="flex items-center">
                    ...
                    <a className="text-gray-600 hover:text-gray-900" href={`mailto:${t('contact.emailText')}`}>
                      {t('contact.emailText')}
                    </a>
                  </div>
                </div>
